                    ...
                    <div>
                        <table id="menusTable" class="w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-1 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Menu</th>
                                    <th class="px-1 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Icon</th>
                                    <th class="px-1 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Route/URL</th>
                                    <th class="px-1 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Permission</th>
                                    <th class="px-1 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Urutan</th>
                                    <th class="px-1 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
        ...
        $(document).ready(function() {
            ...
            table = $('#menusTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'icon', name: 'icon', className: 'text-left' },
                    { data: 'route_url', name: 'route_url', className: 'text-left' },
                    { data: 'permission_name', name: 'permission_name', className: 'text-left' },
                    { data: 'order', name: 'order', className: 'text-left' },
                    { data: 'is_active', name: 'is_active', className: 'text-left' },
                    { data: 'action', name: 'action', orderable: false, searchable: false, className: 'text-left' }
                ],
                // Pengaturan sorting, pagination, dan responsif
                order: [[4, 'asc']], // Sortir berdasarkan urutan secara ascending
                pageLength: 10,
