<x-adminlte-layout>
    <div>
        <h1 class="my-1 text-3xl font-semibold text-gray-900">{{ __('Manajemen Permission') }}</h1>
    </div>
        ...
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-3 d-flex justify-content-start">
                @if (auth()->user()->hasPermission('permission.create'))
                    <a href="{{ route('permissions.create') }}" class="btn btn-secondary">Tambah Permission Baru</a>
                @endif
            </div>
